...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgInvalidFileType: 'Tipo de archivo inválido para el archivo "{name}". Sólo se permiten archivos "{types}".',
        msgInvalidFileExtension: 'Extensión de archivo inválido para "{name}".  Sólo se permiten archivos "{extensions}".',
