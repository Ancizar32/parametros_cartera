...
AmCharts.parseDefs = function(a, b) {
    for (var c in a) {
        ...
        if (0 < a[c].length && "object" == d)
            ...
            "object" == d ? (e = document.createElementNS(AmCharts.SVG_NS, c), b.appendChild(e), AmCharts.parseDefs(a[c], e)) : b.setAttribute(c, a[c])
    }
};
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) ||
            ...
            for (f = p; f <
                    r; f += n)
                u = AmCharts.roundTo(this.step * f + this.min, t), -1 != String(u).indexOf("e") && (this.exponential = !0, String(u).split("e"));
...
AmCharts.AmGraph = AmCharts.Class({construct: function(a) {
        ...
        for (J = ca; J <= oa; J++) {
            ...
            if (Aa) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    V = Aa.close, vb = Aa.low, Ca = f.getCoordinate(vb), ub = Aa.high, Da = f.getCoordinate(ub);
                la = Aa.open;
                E = f.getCoordinate(V);
                ...
                switch (g) {
                    case "line":
                        if (isNaN(V))
                            z || (this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = []);
                        else {
                            ...
                            if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength))
                                this.drawLineGraph(x, u, P, Q), x = [F], u = [E], P = [], Q = [], !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)), l ? Ka ? (this.lineColorSwitched =
                    ...
                    case "smoothedLine":
                        if (isNaN(V))
                            z || (this.drawSmoothedGraph(x, u, P, Q), x = [], u = [], P = [], Q = []);
                        else {
                            if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib)
                                x.push(F), u.push(E), gb = F, hb = E;
                            xa = F;
                    ...
                    case "step":
                        if (!isNaN(V)) {
                            ...
                            if (Jb || v.gap)
                                w = y = NaN, this.drawLineGraph(x, u, P, Q), x = [], u = [], P = [], Q = []
                        } else if (!z) {
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(x, u, P,
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < u)
                if (n = a.join(";").split(";"), r = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(),
                        ...
                        n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(h, n, r, q, f, 1, "#000", 0, a), b.pattern(e.pattern), AmCharts.setCN(g, b, e.bcn + "fill"), k.push(b)), x || void 0 !== t)
                    isNaN(u) && (u = f), x || (x = t), h = AmCharts.polygon(h, n, r, x, u, 1, "#000", 0, a), AmCharts.setCN(g, h, e.bcn + "fill"), AmCharts.setCN(g, h, e.bcn + "fill-negative"), h.pattern(e.pattern), l.push(h), l.click(function(a) {
                        e.handleGraphEvent(a, "clickGraph")
                    }).mouseover(function(a) {
                        e.handleGraphEvent(a, "rollOverGraph")
                    }).mouseout(function(a) {
        ...
        b && (this.rotate ? (b.translate(-1E3, e), c.translate(-1E3, e)) : (b.translate(d,
                -1E3), c.translate(d, -1E3)), b.animate({opacity: 1, translate: d + "," + e}, f, a), c.animate({opacity: 1, translate: d + "," + e}, f, a))
    }, animate: function(a) {
        ...
        if (!isNaN(b) && !isNaN(c)) {
            ...
            if (this.customBullet || a.customBullet)
                r = this.customBullet, a.customBullet && (r = a.customBullet), r && (p && p.remove(), "function" == typeof r ? (p = new r, p.chart = d, a.bulletConfig && (p.availableSpace = c, p.graph =
...
AmCharts.ChartCursor = AmCharts.Class({construct: function(a) {
        ...
        this.leaveCursor || (this.hideObj(this.set), this.hideObj(this.categoryBalloon), this.hideObj(this.line), this.hideObj(this.vLine), this.hideObj(this.hLine), this.hideObj(this.vaBalloon),
                this.hideObj(this.allBullets), this.destroyValueBalloons(), this.selectWithoutZooming || AmCharts.remove(this.selection), this.previousIndex = NaN, a && this.fire("onHideCursor", {type: "onHideCursor", chart: this.chart, target: this}), this.drawing || this.chart.setMouseCursor("auto"), this.normalizeBulletSize())
                    ...
                    if (this.forceShow = !1, C) {
                        ...
                        if (this.oneBalloonOnly) {
                            ...
                            for (g = 0; g < B.length; g++)
                                u = B[g], u.showBalloon && !u.hidden && u.balloonText &&
                        ...
                        if (a != this.previousIndex || H != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                ...
                                for (g = 0; g < B.length; g++)
                                    if (u = B[g], x = NaN, (!this.oneBalloonOnly || u == H) && u.showBalloon && !u.hidden && u.balloonText &&
                                            ("step" == u.type && "left" == u.stepDirection && (r = this.data[a + 1]), r)) {
                                        if (w = r.axes[u.valueAxis.id].graphs[u.id])
                                            x = w.y;
                                        if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length)
                                            for (q = a + 1; q < this.data.length; q++)
                                                if (d = this.data[q])
                                                    if (w = d.axes[u.valueAxis.id].graphs[u.id], x = w.y, !isNaN(x))
                                                        break;
                                        if (!isNaN(x)) {
                                            d = w.x;
                                            k = !0;
                                            ...
                                            k && (k = this.graphBulletSize, D = this.graphBulletAlpha, 1 == k && isNaN(D) || !AmCharts.isModern || !(y = w.bulletGraphics) || (y.getBBox(), y.translate(w.bx,
                                                    ...
                                                    w, !0), (d = u.balloonFunction) && (q = d(w, u).toString()), "" !== q && (t ? k.showBalloon(q) : (k.text = q, k.show = !0), z.push({yy: x, balloon: k})), !t && k.set && (k.set.hide(), u = k.textDiv) && (u.style.visibility = "hidden"))
                                        }
                                    }
    ...
    handleMouseUp: function() {
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"),
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function(a) {
        ...
        if (this.skipEvent)
            ...
            if (h.parseDates && !h.equalSpacing) {
                ...
                h.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, h.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))),
                        this.fire(f.type, f);
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < t && (t = 359.94);
    e >= t && (e = t);
    var z = 1 / 180 * Math.PI, t = b + Math.sin(d * z) * h, x = c - Math.cos(d * z) * r, u = b + Math.sin(d * z) * f, w = c - Math.cos(d * z) * g, y = b + Math.sin((d + e) * z) * f, A = c - Math.cos((d + e) * z) * g, C = b + Math.sin((d + e) * z) * h, z = c - Math.cos((d + e) * z) * r, B = {fill: AmCharts.adjustLuminosity(l.fill, -.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, H = 0;
    180 < Math.abs(e) && (H = 1);
    d = a.set();
    var D;
...
AmCharts.AmLegend = AmCharts.Class({construct: function(a) {
        ...
        this.titleWidth = 0;
        if (e = this.title)
            e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), AmCharts.setCN(a, e, "legend-title"),
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                    g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), AmCharts.setCN(b, m, "graph-stroke"), g.push(m), a.bullet && (a.hidden || (d = a.bulletColorR), m =
